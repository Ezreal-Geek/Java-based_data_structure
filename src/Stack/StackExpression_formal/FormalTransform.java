package Stack.StackExpression_formal;

import java.util.Scanner;
import java.util.Stack;

public class FormalTransform {

    /**
     * Example of converting an infix-expression to Polish Notation (PN) or
     * Reverse Polish Notation (RPN). Written in 2011-8-25
     */
    ...
    private static double calc(double num1, double num2, char op)
        ...
        switch (op) {
            ...
            case '/':
                ...
                return num1 / num2;
            /*
             * case '%': if (num2 == 0) throw new
             * IllegalArgumentException("divisor can't be 0."); return num1 %
             * num2;
             */
            default:
